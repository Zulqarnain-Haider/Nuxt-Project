  ...
  <nav class="bg-bgNav text-mainText px-4 sm:px-6 md:px-8 lg:px-10 py-4 md:py-5 lg:py-6
    ...
    <div class="flex items-center gap-2 sm:gap-3 md:gap-4">
      ...
      <div class="flex xl:hidden items-center gap-2 sm:gap-3 md:gap-4">
        ...
        <img src="/games/Navbar-logo.svg.svg" alt="E-Game Store" class="h-8 sm:h-9 xl:h-8 w-auto flex xl:hidden" />
      </div>
      ...
      <div class="hidden xl:flex items-center gap-4 2xl:gap-6">
        ...
        <NuxtLink to="#" class="bg-primary text-mainText px-4 py-1.5 rounded-md 
