<template>
  <section class="relative w-full text-white overflow-hidden">
    <div class="max-w-7xl mx-auto  relative  sm:px-6 lg:px-8">
      <!-- Background Image -->
      <div class="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-[10%] h-[90%]"
      ...
      <div class="relative w-full pl-20 md:pl-0 md:pr-0 sm:pr-20">
        ...
        <!-- Left Arrow -->
        <button class="swiper-button-prev-custom absolute top-1/3 -left-3 lg:left-2 xl:-left-14 bg-black/40 hover:bg-primary/70 p-2 z-30 hidden sm:flex">
        ...
        <button class="swiper-button-next-custom absolute top-1/3 right-0 md:-right-2 lg:-right-5
             bg-black/20 hover:bg-primary/70 p-2 z-30 hidden sm:flex">
      ...
      <div class="relative w-full mt-16 md:mt-20 flex justify- items-center text-center 
        ...
        <img src="/games/BigTournamentVector.png" alt="vector"
        ...
        <img src="/games/BigTournamentVectorMobile.png" alt="vector mobile"
        ...
        <div class="relative z-20 flex flex-col mt-9 sm:mt-7 -ml-16 sm:ml-[20%] md:ml-[20%] lg:ml-[28%] xl:ml-[30%] 2xl:ml-[32%] items-center justify-start text-center 
          ...
          <UiButton variant="primary" :width="0" :height="42" extraClass="px-5 sm:px-7 md:px-8 py-2 mt-2 text-[0.8rem] sm:text-[0.9rem] md:text-[1rem] lg:text-[1.1rem]
