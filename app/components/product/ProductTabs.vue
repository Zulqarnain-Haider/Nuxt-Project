<template>
  <section class="py-">
    ...
    <div
      ...
      class="text-mainText text-md md:text-base border rounded-lg border-onFooter bg-bgDark p-4 mx-2 leading-relaxed"
    >
      <p>
...
>
  ...
  <div class="flex gap-8 min-w-max">
    ...
    <div
      ...
      class="text-mainText text-sm md:text-base border rounded-lg border-onFooter bg-bgDark p-4 mx-2 leading-relaxed"
    >
...
const videoSource = computed(() => '/videos')   // optional sample video
