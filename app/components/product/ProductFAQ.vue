<template>
  <section class="text-white font-poppins">
    ...
    >
      ...
      <i
        class="fa-solid fa-chevron-up text-lg transition-transform duration-300"
    ...
    >
      ...
      >
        <!-- Question Row -->
        <div
          class="flex justify-between items-center px-4 py-3 cursor-pointer bg-bgDark hover:bg-bgDark/70 transition"
