<template>
  <div class="min-h-screen font-poppins text-mainText py-10 px-6 md:px-12">
    <div class="max-w-6xl mx-auto space-y-8">
      ...
      <div v-if="order" class="bg-bgDark rounded-xl p-6 space-y-5">
        <!-- Header -->
        ...
        <div class="flex flex-col sm:flex-row md:space-x-10 lg:space-x-32 gap-4 mt-3 text-sm sm:text-base">
          <div>
            ...
            <p class="text-md text-primary whitespace-nowrap">#{{ order.code }}</p>
          </div>
          ...
          <div class="flex justify-start items-center gap-2">
            ...
            <div>
              ...
              <p class="">{{ order.location || 'Not specified' }}</p>
            </div>
          </div>
...
import OrderProgress from '~/components/modals/OrderProgress.vue'
import OrderKeyModal from '~/components/modals/OrderKeyModal.vue'
...
// Baaki orders (selected ke ilawa)
...
const openKeyModal = () => (showModal.value = true)
</script>
